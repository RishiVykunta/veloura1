          ...
          <div className="grid md:grid-cols-[1.1fr_0.9fr] gap-6">
            <div className="bg-cream rounded-2xl border border-cream-dark p-6 md:p-10 shadow-premium">
              ...
              <p className="text-dark/75 leading-relaxed mb-6">
                For customer support, product questions, order help, or exchange requests, please email our team and
            ...
            <div className="bg-primary text-white rounded-2xl p-6 md:p-10 shadow-premium">
              <h2 className="font-heading text-2xl font-bold mb-4">Veloura Support</h2>
              ...
              <div className="space-y-3 text-sm text-white/80">
                <p>Order assistance and delivery updates</p>
                <p>Size exchange and product guidance</p>
                <p>Policy support and after-purchase help</p>
              </div>
            </div>
          </div>
        </div>
