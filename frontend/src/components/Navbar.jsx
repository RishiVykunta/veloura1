      ...
      >
        <div className="container mx-auto px-4 md:px-8 h-full flex items-center justify-between relative">
          ...
          <Link to="/" className="flex items-center md:static absolute left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2 md:translate-x-0 md:translate-y-0 md:top-auto">
            <img src="https://res.cloudinary.com/dqcxekzxn/image/upload/v1783666640/Screenshot_2026-07-10_122640_aswgmm.png" alt="Veloura" className="h-8 md:h-11 w-auto object-contain rounded-sm shadow-sm" />
          </Link>
          ...
          <>
            ...
            >
              <div className="p-4 flex justify-between items-center border-b border-cream">
                <img src="https://res.cloudinary.com/dqcxekzxn/image/upload/v1783666640/Screenshot_2026-07-10_122640_aswgmm.png" alt="Veloura" className="h-10 object-contain" />
