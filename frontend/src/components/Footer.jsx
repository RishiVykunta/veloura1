    ...
    <footer className="bg-primary text-white pt-16 pb-8">
      <div className="container mx-auto px-4 md:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          {/* Brand Info */}
          <div>
            <img src="https://res.cloudinary.com/dqcxekzxn/image/upload/v1783666640/Screenshot_2026-07-10_122640_aswgmm.png" alt="Veloura" className="h-10 mb-4 rounded-sm shadow-sm" />
